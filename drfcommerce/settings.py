...
SIMPLE_JWT = {
    ...
    "AUTH_COOKIE_SECURE": False,          # IP-based server cannot use HTTPS
...
CORS_ALLOWED_ORIGINS = [
    f"http://{SERVER_IP}",                         # correct for EC2
    "https://next-e-commerce.onrender.com",
    "http://localhost:3000",
]

CSRF_TRUSTED_ORIGINS = [
    f"http://{SERVER_IP}",                        # NO HTTPS for IP
    "https://next-e-commerce.onrender.com",
]
...
# ---------------------------------------
# SECURITY (No SSL because IP cannot support SSL)
# ---------------------------------------
